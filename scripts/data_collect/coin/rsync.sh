...
rsync -avz -e "ssh -i /root/.ssh/ali_key" -r root@54.95.226.129:/running/coin/OKEXcointick$date_string.dat.gz /home/nick/coin
ssh -i /root/.ssh/ali_key root@54.95.226.129 "rm /running/coin/OKEXcointick$date_string.dat.gz"

rsync -avz -e "ssh -i /root/.ssh/ali_key" -r root@54.95.226.129:/running/coin/BINANCEcointick$date_string.dat.gz /home/nick/coin
ssh -i /root/.ssh/ali_key root@54.95.226.129 "rm /running/coin/BINANCEcointick$date_string.dat.gz"
